...
layout (location = 6) in vec3 Ka;
layout (location = 7) in vec3 Kd;
layout (location = 8) in vec3 Ks;
layout (location = 9) in vec3 La;
layout (location = 10) in vec3 Ld;
layout (location = 11) in vec3 Ls;
